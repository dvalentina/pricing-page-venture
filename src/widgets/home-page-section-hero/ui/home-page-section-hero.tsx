...
export function HeroSection() {
  return (
    <section className="relative w-full flex justify-center items-center min-h-[680px]">
      <div className={clsx(gradientClassName, "top-0 bg-linear-to-b")} />
      <div className="max-w-(--content-max-width) py-24 px-20 flex justify-start items-center w-full h-full bg-[url(/home-page-pattern-dotted-lines.svg)] bg-cover relative">
        ...
        <Image
          ...
          height="680"
          width="704"
          className="absolute top-0 left-[750px]"
        />
      </div>
